...
public enum ApplicationEnmu {
    ...
    INA_XM_MASBANTUAN(513,"MasBantuan","id_ID"),    // 印尼 com.example.daman
    INA_XM_MASBANTUAN_SSS(514,"SuperSiNa","id_ID"),    // 印尼 com.example.daman
    ...
    INA_COM_JUNP_LINKPLUS_521(521,"CashDog","id_ID"),    // 印尼 inacashkangaroo.app
    ...
    //印度CPI
    INDIA_CASH_KANGAROO(30001,"CashKangaroo","en_IN"),    // 中国  营销短信发送
    ;
